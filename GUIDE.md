This is the guide that maps circled numbers in the online paper to locations in the code.
...
**Location**: In a different repository; follow the link in the paper.
