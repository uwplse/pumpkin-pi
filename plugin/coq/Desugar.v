...
Section ListTests.
  ...
  Definition expected_hd : forall A : Type, A -> forall l : list A, A :=
  ...
  Definition expected_hd_error : forall (A : Type) (l : list A), option A :=
    fun (A : Type) (l : list A) =>
  ...
  Definition expected_tl : forall (A : Type) (l : list A), list A :=
    fun (A : Type) (l : list A) =>
  ...
  Definition expected_In : forall A : Type, A -> list A -> Prop :=
  ...
  Definition expected_nil_cons : forall (A : Type) (x : A) (l : list A), nil <> (x :: l)%list :=
    fun (A : Type) (x : A) (l : list A) (H : nil = (x :: l)%list) =>
      let H0 : False :=
          eq_ind nil
                 (fun e : list A =>
  ...
  Definition expected_destruct_list :
    forall (A : Type) (l : list A), {x : A & {tl : list A | l = (x :: tl)%list}} + {l = nil} :=
    fun (A : Type) (l : list A) =>
      list_rect
        (fun l0 : list A =>
           {x : A & {tl : list A | l0 = (x :: tl)%list}} + {l0 = nil})
        (inright eq_refl)
        (fun (a : A) (tail : list A)
             (_ : {x : A & {tl : list A | tail = (x :: tl)%list}} + {tail = nil}) =>
           inleft
             (existT (fun x : A => {tl : list A | (a :: tail)%list = (x :: tl)%list})
                     a
                     (exist (fun tl : list A => (a :: tail)%list = (a :: tl)%list) tail
                            eq_refl))) l.
  ...
  Definition expected_hd_error_tl_repr :
    forall (A : Type) (l : list A) (a : A) (r : list A),
      List.hd_error l = Some a /\ List.tl l = r <-> l = (a :: r)%list :=
    fun (A : Type) (l : list A) =>
      list_ind
        (fun l0 : list A =>
           forall (a : A) (r : list A),
             List.hd_error l0 = Some a /\ List.tl l0 = r <-> l0 = (a :: r)%list)
        (fun (a : A) (r : list A) =>
           conj
        ...
        (fun (x : A) (xs : list A)
             (_ : forall (a : A) (r : list A),
                 List.hd_error xs = Some a /\ List.tl xs = r <-> xs = (a :: r)%list)
             (a : A) (r : list A) =>
           conj
             (fun H : Some x = Some a /\ xs = r =>
                and_ind
                  (fun (H1 : Some x = Some a) (H2 : xs = r) =>
                     let H0 : Some a = Some a -> (x :: xs)%list = (a :: r)%list :=
                         eq_ind (Some x)
                                (fun y : option A =>
                                   y = Some a -> (x :: xs)%list = (a :: r)%list)
                                (fun H0 : Some x = Some a =>
                                   (fun H3 : Some x = Some a =>
                                      ...
                                      (fun H5 : x = a =>
                                         let H6 : x = a := H5 in
                                         eq_ind_r (fun a0 : A => (a0 :: xs)%list = (a :: r)%list)
                                                  (eq_ind_r
                                                     (fun xs0 : list A => (a :: xs0)%list = (a :: r)%list)
                                                     eq_refl H2) H6) H4) H0) (Some a) H1 in
                     H0 eq_refl) H)
             (fun H : (x :: xs)%list = (a :: r)%list =>
                let H0 : (a :: r)%list = (a :: r)%list -> Some x = Some a /\ xs = r :=
                    eq_ind (x :: xs)%list
                           (fun y : list A => y = (a :: r)%list -> Some x = Some a /\ xs = r)
                           (fun H0 : (x :: xs)%list = (a :: r)%list =>
                              (fun H1 : (x :: xs)%list = (a :: r)%list =>
                                 let H2 : xs = r :=
                                     f_equal
                                       (fun e : list A =>
                                                 ...
                                                 eq_ind_r (fun l0 : list A => Some a = Some a /\ l0 = r)
                                                          (eq_ind_r
                                                             (fun x0 : A =>
                                                                (x0 :: xs)%list = (a :: r)%list ->
                                                                Some a = Some a /\ r = r)
                                                             (fun H8 : (a :: xs)%list = (a :: r)%list =>
                                                                eq_ind_r
                                                                  (fun xs0 : list A =>
                                                                     (a :: xs0)%list = (a :: r)%list ->
                                                                     Some a = Some a /\ r = r)
                                                                  (fun _ : (a :: r)%list = (a :: r)%list =>
  ...
  Definition expected_length_zero_iff_nil :
    forall (A : Type) (l : list A),
      (length l = 0 -> l = nil) /\ (l = nil -> length l = 0) :=
    fun (A : Type) (l : list A) =>
      conj
        (list_ind (fun l0 : list A => length l0 = 0 -> l0 = nil)
                  ...
                  (fun (a : A) (l0 : list A) (_ : length l0 = 0 -> l0 = nil)
                       (H : length (a :: l0) = 0) =>
                     let H0 : 0 = 0 -> (a :: l0)%list = nil :=
                         eq_ind (length (a :: l0))
                                (fun y : nat => y = 0 -> (a :: l0)%list = nil)
                                (fun H0 : length (a :: l0) = 0 =>
                                   (fun H1 : length (a :: l0) = 0 =>
                                      ...
                                      False_ind ((a :: l0)%list = nil) H2) H0) 0 H in
                     H0 eq_refl) l)
  ...
  Definition expected_hd_error_nil : forall A : Type, List.hd_error (@nil A) = None :=
    fun A : Type => eq_refl.
  ...
  Definition expected_hd_error_cons :
    forall (A : Type) (l : list A) (x : A), List.hd_error (x :: l) = Some x :=
    fun (A : Type) (l : list A) (x : A) => eq_refl.
  Lemma test_hd_error_cons : actual_hd_error_cons = expected_hd_error_cons. Proof. reflexivity. Qed.

  Desugar in_eq as actual_in_eq.
  Definition expected_in_eq : forall (A : Type) (a : A) (l : list A), List.In a (a :: l) :=
    fun (A : Type) (a : A) (l : list A) => or_introl eq_refl.
  Lemma test_in_eq : actual_in_eq = expected_in_eq. Proof. reflexivity. Qed.

  Desugar in_cons as actual_in_cons.
  Definition expected_in_cons : forall (A : Type) (a b : A) (l : list A), List.In b l -> List.In b (a :: l) :=
    fun (A : Type) (a b : A) (l : list A) (H : List.In b l) => or_intror H.
  Lemma test_in_cons : actual_in_cons = expected_in_cons. Proof. reflexivity. Qed.

  Desugar not_in_cons as actual_not_in_cons.
  Definition expected_not_in_cons : forall (A : Type) (x a : A) (l : list A),
      ~ List.In x (a :: l) <-> x <> a /\ ~ List.In x l :=
    fun (A : Type) (x a : A) (l : list A) =>
      conj
  ...
  Definition expected_in_nil : forall (A : Type) (a : A), ~ List.In a nil :=
    fun (A : Type) (a : A) (H : List.In a nil) =>
  ...
  Definition expected_in_split : forall (A : Type) (x : A) (l : list A),
      List.In x l -> exists l1 l2 : list A, l = (l1 ++ x :: l2)%list :=
    fun (A : Type) (x : A) (l : list A) =>
      list_ind
        (fun l0 : list A =>
           List.In x l0 -> exists l1 l2 : list A, l0 = (l1 ++ x :: l2)%list)
        (fun H : False =>
           False_ind (exists l1 l2 : list A, nil = (l1 ++ x :: l2)%list) H)
        (fun (a : A) (l0 : list A)
             (IHl : List.In x l0 -> exists l1 l2 : list A, l0 = (l1 ++ x :: l2)%list)
             (H : a = x \/ List.In x l0) =>
           or_ind
             (fun H0 : a = x =>
                eq_ind_r
                  (fun a0 : A =>
                     exists l1 l2 : list A, (a0 :: l0)%list = (l1 ++ x :: l2)%list)
                  (ex_intro
                     (fun l1 : list A =>
                        exists l2 : list A, (x :: l0)%list = (l1 ++ x :: l2)%list) nil
                     (ex_intro
                        (fun l2 : list A => (x :: l0)%list = (nil ++ x :: l2)%list) l0
                        eq_refl)) H0)
             (fun H0 : List.In x l0 =>
                let e : exists l1 l2 : list A, l0 = (l1 ++ x :: l2)%list := IHl H0 in
                ex_ind
                  (fun (l1 : list A)
                       (H1 : exists l2 : list A, l0 = (l1 ++ x :: l2)%list) =>
                     ex_ind
                       (fun (l2 : list A) (H2 : l0 = (l1 ++ x :: l2)%list) =>
                          ex_intro
                            (fun l3 : list A =>
                               exists l4 : list A, (a :: l0)%list = (l3 ++ x :: l4)%list)
                            (a :: l1)%list
                            (ex_intro
                               (fun l3 : list A =>
                                  (a :: l0)%list = ((a :: l1) ++ x :: l3)%list) l2
  ...
  Definition expected_in_dec : forall A : Type,
      (forall x y : A, {x = y} + {x <> y}) -> forall (a : A) (l : list A), {List.In a l} + {~ List.In a l} :=
    fun (A : Type) (H : forall x y : A, {x = y} + {x <> y}) (a : A) (l : list A) =>
  ...
  Definition expected_app_cons_not_nil : forall (A : Type) (x y : list A) (a : A), nil <> (x ++ a :: y)%list :=
    fun (A : Type) (x : list A) =>
      list_ind
        (fun l : list A =>
           forall (y : list A) (a : A), nil = (l ++ a :: y)%list -> False)
        (fun (y : list A) (a : A) (H : nil = (a :: y)%list) =>
           let H0 : False :=
               eq_ind nil
                      (fun e : list A =>
                         list_rect (fun _ : list A => Prop) True
           ...
           False_ind False H0)
        (fun (a : A) (l : list A)
             (_ : forall (y : list A) (a0 : A), nil = (l ++ a0 :: y)%list -> False)
             (y : list A) (a0 : A) (H : nil = (a :: l ++ a0 :: y)%list) =>
           let H0 : False :=
               eq_ind nil
                      (fun e : list A =>
                         list_rect (fun _ : list A => Prop) True
  ...
  Definition expected_app_nil_l : forall (A : Type) (l : list A), nil ++ l = l :=
    fun (A : Type) (l : list A) => eq_refl.
  Lemma test_app_nil_l : actual_app_nil_l = expected_app_nil_l. Proof. reflexivity. Qed.

  Desugar app_nil_r as actual_app_nil_r.
  Definition expected_app_nil_r : forall (A : Type) (l : list A), (l ++ nil)%list = l :=
    fun (A : Type) (l : list A) =>
      list_ind (fun l0 : list A => (l0 ++ nil)%list = l0)
               (let H : A = A := eq_refl in (fun _ : A = A => eq_refl) H)
               (fun (a : A) (l0 : list A) (IHl : (l0 ++ nil)%list = l0) =>
                  let H : (l0 ++ nil)%list = l0 := IHl in
                  (let H0 : a = a := eq_refl in
                   (let H1 : A = A := eq_refl in
                    (fun (_ : A = A) (_ : a = a) (H4 : (l0 ++ nil)%list = l0) =>
                       eq_trans
                         (f_equal (fun f : list A -> list A => f (l0 ++ nil)%list) eq_refl)
  ...
  Definition expected_app_nil_end : forall (A : Type) (l : list A), l = (l ++ nil)%list :=
    fun (A : Type) (l : list A) => eq_sym (List.app_nil_r l).
  ...
  Definition expected_app_assoc : forall (A : Type) (l m n : list A), (l ++ m ++ n)%list = ((l ++ m) ++ n)%list :=
    fun (A : Type) (l m n : list A) =>
      list_ind (fun l0 : list A => (l0 ++ m ++ n)%list = ((l0 ++ m) ++ n)%list)
               (let H : n = n := eq_refl in
                (let H0 : m = m := eq_refl in
                 (let H1 : A = A := eq_refl in
                  (fun (_ : A = A) (_ : m = m) (_ : n = n) => eq_refl) H1) H0) H)
               (fun (a : A) (l0 : list A)
                    (IHl : (l0 ++ m ++ n)%list = ((l0 ++ m) ++ n)%list) =>
                  let H : (l0 ++ m ++ n)%list = ((l0 ++ m) ++ n)%list := IHl in
                  (let H0 : a = a := eq_refl in
                   (let H1 : A = A := eq_refl in
                    (fun (_ : A = A) (_ : a = a)
                         (H4 : (l0 ++ m ++ n)%list = ((l0 ++ m) ++ n)%list) =>
                       eq_trans
                         (f_equal (fun f : list A -> list A => f (l0 ++ m ++ n)%list) eq_refl)
                         (f_equal (cons a) H4)) H1) H0) H) l.
  ...
  Definition expected_app_assoc_reverse : forall (A : Type) (l m n : list A),
      ((l ++ m) ++ n)%list = (l ++ m ++ n)%list :=
    fun (A : Type) (l m n : list A) => eq_sym (List.app_assoc l m n).
  ...
  Definition expected_app_comm_cons : forall (A : Type) (x y : list A) (a : A), (a :: x) ++ y = ((a :: x) ++ y)%list :=
  ...
  Definition expected_app_eq_nil : forall (A : Type) (l : list A), forall l' : list A, (l ++ l')%list = nil -> l = nil /\ l' = nil :=
    fun (A : Type) (l : list A) =>
      list_ind
        (fun l0 : list A =>
           forall l' : list A, (l0 ++ l')%list = nil -> l0 = nil /\ l' = nil)
        (fun l' : list A =>
           list_ind
             (fun l0 : list A => (nil ++ l0)%list = nil -> nil = nil /\ l0 = nil)
             (fun H : nil = nil => conj H H)
             (fun (y : A) (l'0 : list A)
                  (_ : (nil ++ l'0)%list = nil -> nil = nil /\ l'0 = nil)
                  (H : (y :: l'0)%list = nil) => conj eq_refl H) l')
        (fun (x : A) (l0 : list A)
             (_ : forall l' : list A, (l0 ++ l')%list = nil -> l0 = nil /\ l' = nil)
             (l' : list A) =>
           list_ind
             (fun l1 : list A =>
                ((x :: l0) ++ l1)%list = nil -> (x :: l0)%list = nil /\ l1 = nil)
             (fun H : (x :: l0 ++ nil)%list = nil =>
                let H0 : False :=
                    eq_ind (x :: l0 ++ nil)%list
                           (fun e : list A =>
                              list_rect (fun _ : list A => Prop) False
                                        (fun (_ : A) (_ : list A) (_ : Prop) => True) e) I nil H in
                False_ind ((x :: l0)%list = nil /\ nil = nil) H0)
             (fun (y : A) (l'0 : list A)
                  (_ : ((x :: l0) ++ l'0)%list = nil ->
                       (x :: l0)%list = nil /\ l'0 = nil)
                  (H : (x :: l0 ++ y :: l'0)%list = nil) =>
                let H0 : False :=
                    eq_ind (x :: l0 ++ y :: l'0)%list
                           (fun e : list A =>
                              list_rect (fun _ : list A => Prop) False
                                        (fun (_ : A) (_ : list A) (_ : Prop) => True) e) I nil H in
                False_ind ((x :: l0)%list = nil /\ (y :: l'0)%list = nil) H0) l') l.
  ...
  Definition expected_app_eq_unit : forall (A : Type) (x y : list A) (a : A),
      (x ++ y)%list = (a :: nil)%list -> x = nil /\ y = (a :: nil)%list \/ x = (a :: nil)%list /\ y = nil :=
    fun (A : Type) (x : list A) =>
      list_ind
        (fun l : list A =>
           forall (y : list A) (a : A),
             (l ++ y)%list = (a :: nil)%list ->
             l = nil /\ y = (a :: nil)%list \/ l = (a :: nil)%list /\ y = nil)
        (fun y : list A =>
           list_ind
             (fun l : list A =>
                forall a : A,
                  (nil ++ l)%list = (a :: nil)%list ->
                  nil = nil /\ l = (a :: nil)%list \/ nil = (a :: nil)%list /\ l = nil)
             (fun (a : A) (H : nil = (a :: nil)%list) =>
                let H0 : False :=
                    eq_ind nil
                           (fun e : list A =>
                              list_rect (fun _ : list A => Prop) True
                           ...
                           (a :: nil)%list H in
                False_ind
                  (nil = nil /\ nil = (a :: nil)%list \/
                                nil = (a :: nil)%list /\ nil = nil) H0)
             (fun (a : A) (l : list A)
                  (_ : forall a0 : A,
                      (nil ++ l)%list = (a0 :: nil)%list ->
                      nil = nil /\ l = (a0 :: nil)%list \/
                                   nil = (a0 :: nil)%list /\ l = nil) (a0 : A)
                  (H : (a :: l)%list = (a0 :: nil)%list) =>
                or_introl (conj eq_refl H)) y)
        (fun (a : A) (l : list A)
             (_ : forall (y : list A) (a0 : A),
                 (l ++ y)%list = (a0 :: nil)%list ->
                 l = nil /\ y = (a0 :: nil)%list \/ l = (a0 :: nil)%list /\ y = nil)
             (y : list A) =>
           list_ind
             (fun l0 : list A =>
                forall a0 : A,
                  ((a :: l) ++ l0)%list = (a0 :: nil)%list ->
                  (a :: l)%list = nil /\ l0 = (a0 :: nil)%list \/
                                         (a :: l)%list = (a0 :: nil)%list /\ l0 = nil)
             (fun (a0 : A) (H : (a :: l ++ nil)%list = (a0 :: nil)%list) =>
                or_intror
                  (conj
                     ((fun E : (l ++ nil)%list = l =>
                         eq_ind_r
                           (fun l0 : list A =>
                              (a :: l0)%list = (a0 :: nil)%list ->
                              (a :: l)%list = (a0 :: nil)%list)
                           (fun H0 : (a :: l)%list = (a0 :: nil)%list => H0) E)
                        (List.app_nil_r l) H) eq_refl))
             (fun (a0 : A) (l0 : list A)
                  (_ : forall a1 : A,
                      ((a :: l) ++ l0)%list = (a1 :: nil)%list ->
                      (a :: l)%list = nil /\ l0 = (a1 :: nil)%list \/
                                             (a :: l)%list = (a1 :: nil)%list /\ l0 = nil)
                  (a1 : A) (H : (a :: l ++ a0 :: l0)%list = (a1 :: nil)%list) =>
                let H0 : (l ++ a0 :: l0)%list = nil :=
                    f_equal
                      (fun e : list A =>
                                   ...
                                   ((fun l1 : list A =>
                                       list_rect (fun _ : list A => list A -> list A)
                                                 ...
                                                 (fun (a2 : A) (_ : list A) (app : list A -> list A)
                                                      (m : list A) => (a2 :: app m)%list) l1) l
                                                                                              (a0 :: l0)%list) (fun (_ : A) (l1 _ : list A) => l1) e) H in
                (let H1 : a = a1 :=
                     f_equal
                       (fun e : list A =>
                          list_rect (fun _ : list A => A) a
                                    (fun (a2 : A) (_ : list A) (_ : A) => a2) e) H in
                 (fun (_ : a = a1) (H3 : (l ++ a0 :: l0)%list = nil) =>
                    let H4 : nil = (l ++ a0 :: l0)%list := eq_sym H3 in
                    let H5 : False := List.app_cons_not_nil l l0 a0 H4 in
                    False_ind
                      ((a :: l)%list = nil /\ (a0 :: l0)%list = (a1 :: nil)%list \/
                                              (a :: l)%list = (a1 :: nil)%list /\ (a0 :: l0)%list = nil) H5) H1)
                  H0) y) x.
  ...
  Definition expected_app_length : forall (A : Type) (l l' : list A), length (l ++ l') = length l + length l' :=
    fun (A : Type) (l : list A) =>
      list_ind
        (fun l0 : list A =>
  ...
  Definition expected_in_app_or : forall (A : Type) (l m : list A) (a : A), List.In a (l ++ m) -> List.In a l \/ List.In a m :=
  ...
  Definition expected_in_or_app : forall (A : Type) (l m : list A) (a : A), List.In a l \/ List.In a m -> List.In a (l ++ m) :=
    fun (A : Type) (l m : list A) (a : A) =>
      list_ind
  ...
  Definition expected_in_app_iff : forall (A : Type) (l l' : list A) (a : A),
      (List.In a (l ++ l') -> List.In a l \/ List.In a l') /\ (List.In a l \/ List.In a l' -> List.In a (l ++ l')) :=
  ...
  Definition expected_app_inv_head : forall (A : Type) (l l1 l2 : list A), (l ++ l1)%list = (l ++ l2)%list -> l1 = l2 :=
    fun (A : Type) (l : list A) =>
      list_ind
        (fun l0 : list A =>
           forall l1 l2 : list A, (l0 ++ l1)%list = (l0 ++ l2)%list -> l1 = l2)
        (fun (l1 l2 : list A) (H : l1 = l2) => H)
        (fun (a : A) (l0 : list A)
             (IHl : forall l1 l2 : list A,
                 (l0 ++ l1)%list = (l0 ++ l2)%list -> l1 = l2)
             (l1 l2 : list A) (H : (a :: l0 ++ l1)%list = (a :: l0 ++ l2)%list) =>
           let H0 : (l0 ++ l1)%list = (l0 ++ l2)%list :=
               f_equal
                 (fun e : list A =>
                    list_rect (fun _ : list A => list A)
                              ((fun l3 : list A =>
                                  list_rect (fun _ : list A => list A -> list A)
                                            ...
                                            (fun (a0 : A) (_ : list A) (app : list A -> list A)
                                                 (m : list A) => (a0 :: app m)%list) l3) l0 l1)
                              (fun (_ : A) (l3 _ : list A) => l3) e) H in
           (fun H1 : (l0 ++ l1)%list = (l0 ++ l2)%list => IHl l1 l2 H1) H0) l.
  ...
  Definition expected_app_inv_tail : forall (A : Type) (l l1 l2 : list A), (l1 ++ l)%list = (l2 ++ l)%list -> l1 = l2 :=
    fun (A : Type) (l l1 l2 : list A) =>
      (fun l3 : list A =>
         list_ind
           (fun l4 : list A =>
              forall l5 l0 : list A, (l4 ++ l0)%list = (l5 ++ l0)%list -> l4 = l5)
           (fun l4 : list A =>
              list_ind
                (fun l0 : list A =>
                   forall l5 : list A, (nil ++ l5)%list = (l0 ++ l5)%list -> nil = l0)
                (fun (l0 : list A) (_ : l0 = l0) => eq_refl)
                (fun (x2 : A) (l5 : list A)
                     (_ : forall l0 : list A,
                         (nil ++ l0)%list = (l5 ++ l0)%list -> nil = l5)
                     (l0 : list A) (H : l0 = (x2 :: l5 ++ l0)%list) =>
                   False_ind (nil = (x2 :: l5)%list)
                             (eq_ind_r (fun n : nat => ~ S n <= length l0)
                                       ...
                                       (eq_ind l0 (fun l6 : list A => length l6 <= length l0)
                                               (le_n (length l0)) (x2 :: l5 ++ l0)%list H))) l4)
           (fun (x1 : A) (l4 : list A)
                (IHl1 : forall l5 l0 : list A,
                    (l4 ++ l0)%list = (l5 ++ l0)%list -> l4 = l5)
                (l5 : list A) =>
              list_ind
                (fun l0 : list A =>
                   forall l6 : list A,
                     ((x1 :: l4) ++ l6)%list = (l0 ++ l6)%list -> (x1 :: l4)%list = l0)
                (fun (l0 : list A) (H : (x1 :: l4 ++ l0)%list = l0) =>
                   False_ind ((x1 :: l4)%list = nil)
                             (eq_ind_r (fun n : nat => ~ S n <= length l0)
                ...
                (fun (x2 : A) (l6 : list A)
                     (_ : forall l0 : list A,
                         ((x1 :: l4) ++ l0)%list = (l6 ++ l0)%list ->
                         (x1 :: l4)%list = l6) (l0 : list A)
                     (H : (x1 :: l4 ++ l0)%list = (x2 :: l6 ++ l0)%list) =>
                   let H0 : (l4 ++ l0)%list = (l6 ++ l0)%list :=
                       f_equal
                         (fun e : list A =>
                            list_rect (fun _ : list A => list A)
                                      ((fun l7 : list A =>
                                          list_rect (fun _ : list A => list A -> list A)
                                                    ...
                                                    (fun (l8 : A) (_ : list A) (app : list A -> list A)
                                                         (m : list A) => (l8 :: app m)%list) l7) l4 l0)
                   ...
                   (let H1 : x1 = x2 :=
                    ...
                    (fun (H2 : x1 = x2) (H3 : (l4 ++ l0)%list = (l6 ++ l0)%list) =>
  ...
  Definition expected_nth : forall A : Type, nat -> list A -> A -> A :=
    fun (A : Type) (n : nat) (l : list A) =>
  ...
  Definition expected_nth_ok: forall A : Type, nat -> list A -> A -> bool :=
    fun (A : Type) (n : nat) (l : list A) =>
  ...
  Definition expected_nth_in_or_default : forall (A : Type) (n : nat) (l : list A) (d : A), {List.In (List.nth n l d) l} + {List.nth n l d = d} :=
    fun (A : Type) (n : nat) (l : list A) (d : A) =>
      list_rec
        (fun l0 : list A =>
  ...
  Definition expected_nth_S_cons : forall (A : Type) (n : nat) (l : list A) (d a : A),
      List.In (List.nth n l d) l -> List.In (List.nth (S n) (a :: l) d) (a :: l) :=
    fun (A : Type) (n : nat) (l : list A) (d a : A)
        (H : List.In (List.nth n l d) l) => or_intror H.
  Lemma test_nth_S_cons : actual_nth_S_cons = expected_nth_S_cons. Proof. reflexivity. Qed.

  Desugar nth_error as actual_nth_error.
  Definition expected_nth_error : forall A : Type, list A -> nat -> option A :=
  ...
  Definition expected_nth_default : forall A : Type, A -> forall (l : list A) (n : nat), A :=
    fun (A : Type) (default : A) (l : list A) (n : nat) =>
  ...
  Definition expected_nth_default_eq : forall (A : Type) (n : nat) (l : list A) (d : A), List.nth_default d l n = List.nth n l d :=
    fun (A : Type) (n : nat) =>
      nat_ind
        (fun n0 : nat =>
           forall (l : list A) (d : A),
  ...
  Definition expected_nth_overflow : forall (A : Type) (l : list A), forall (n : nat) (d : A), length l <= n -> List.nth n l d = d :=
    fun (A : Type) (l : list A) =>
      list_ind
        (fun l0 : list A =>
  ...
  Definition expected_nth_indep : forall (A : Type) (l : list A) (n : nat) (d d' : A),
  ...
  Definition expected_app_nth1 : forall (A : Type) (l : list A) (l' : list A) (d : A) (n : nat),
  ...
  Definition expected_app_nth2 : forall (A : Type) (l l' : list A) (d : A) (n : nat),
  ...
  Definition expected_nth_split : forall (A : Type) (n : nat) (l : list A) (d : A),
      n < length l -> exists l1 l2 : list A, l = (l1 ++ List.nth n l d :: l2)%list /\ length l1 = n :=
    fun (A : Type) (n : nat) (l : list A) (d : A) =>
      nat_ind
        (fun n0 : nat =>
           forall l0 : list A,
             n0 < length l0 ->
             exists l1 l2 : list A,
               l0 = (l1 ++ List.nth n0 l0 d :: l2)%list /\ length l1 = n0)
        (fun l0 : list A =>
           list_ind
             (fun l1 : list A =>
                0 < length l1 ->
                exists l2 l3 : list A,
                  l1 = (l2 ++ List.nth 0 l1 d :: l3)%list /\ length l2 = 0)
             (fun H : 0 < length nil =>
                let H0 :
                      length nil = length nil ->
                      exists l1 l2 : list A,
                        nil = (l1 ++ List.nth 0 nil d :: l2)%list /\ length l1 = 0 :=
                    le_ind 1
                           (fun n0 : nat =>
                              n0 = length nil ->
                              exists l1 l2 : list A,
                           ...
                           (fun (m : nat) (H0 : 1 <= m)
                                (_ : m = length nil ->
                                     exists l1 l2 : list A,
                                       nil = (l1 ++ List.nth 0 nil d :: l2)%list /\
             ...
             (fun (a : A) (l1 : list A)
                ...
                ex_intro
                  (fun l2 : list A =>
                     exists l3 : list A,
                       (a :: l1)%list = (l2 ++ List.nth 0 (a :: l1) d :: l3)%list /\
                       length l2 = 0) nil
                  (ex_intro
                     (fun l2 : list A =>
                        (a :: l1)%list = (nil ++ List.nth 0 (a :: l1) d :: l2)%list /\
        ...
        (fun (n0 : nat)
           ...
           list_ind
             (fun l1 : list A =>
                S n0 < length l1 ->
                exists l2 l3 : list A,
                  l1 = (l2 ++ List.nth (S n0) l1 d :: l3)%list /\ length l2 = S n0)
             (fun H : S n0 < length nil =>
                let H0 :
                      length nil = length nil ->
                      exists l1 l2 : list A,
                        nil = (l1 ++ List.nth (S n0) nil d :: l2)%list /\ length l1 = S n0 :=
                    le_ind (S (S n0))
                           (fun n1 : nat =>
                              n1 = length nil ->
                              exists l1 l2 : list A,
                                nil = (l1 ++ List.nth (S n0) nil d :: l2)%list /\
                                length l1 = S n0)
             ...
             (fun (a : A) (l1 : list A)
                  (_ : S n0 < length l1 ->
                       exists l2 l3 : list A,
                         l1 = (l2 ++ List.nth (S n0) l1 d :: l3)%list /\
                         length l2 = S n0) (H : S n0 < length (a :: l1)) =>
                let e :
                      exists l2 l3 : list A,
                        l1 = (l2 ++ List.nth n0 l1 d :: l3)%list /\ length l2 = n0 :=
                ...
                ex_ind
                  (fun (l2 : list A)
                   ...
                   =>
                     ex_ind
                       (fun (l3 : list A)
                            (H1 : l1 = (l2 ++ List.nth n0 l1 d :: l3)%list /\
                                  length l2 = n0) =>
                          and_ind
                            (fun (Hl : l1 = (l2 ++ List.nth n0 l1 d :: l3)%list)
                                 (Hl1 : length l2 = n0) =>
                               ex_intro
                                 (fun l4 : list A =>
                                    exists l5 : list A,
                                      (a :: l1)%list =
                                      (l4 ++ List.nth (S n0) (a :: l1) d :: l5)%list /\
                                      length l4 = S n0) (a :: l2)%list
                                 (ex_intro
                                    (fun l4 : list A =>
                                       (a :: l1)%list =
                                       ((a :: l2) ++ List.nth (S n0) (a :: l1) d :: l4)%list /\
                                       length (a :: l2) = S n0) l3
                                    (conj
                                       (let H2 : l1 = (l2 ++ List.nth n0 l1 d :: l3)%list :=
                                            Hl in
                                        (let H3 : a = a := eq_refl in
                                         (let H4 : A = A := eq_refl in
                                          (fun (_ : A = A) (_ : a = a)
                                               (H7 : l1 = (l2 ++ List.nth n0 l1 d :: l3)%list)
                                           =>
                                             eq_trans
  ...
  Definition expected_nth_error_In : forall (A : Type) (l : list A) (n : nat) (x : A),
      List.nth_error l n = Some x -> List.In x l :=
    fun (A : Type) (l : list A) (n : nat) (x : A) =>
      list_ind
        (fun l0 : list A =>
  ...
  Definition expected_nth_error_None : forall (A : Type) (l : list A) (n : nat),
  ...
  Definition expected_nth_error_Some : forall (A : Type) (l : list A) (n : nat),
  ...
  Definition expected_nth_error_split : forall (A : Type) (l : list A) (n : nat) (a : A),
      List.nth_error l n = Some a -> exists l1 l2 : list A, l = (l1 ++ a :: l2)%list /\ length l1 = n :=
    fun (A : Type) (l : list A) (n : nat) (a : A) =>
      nat_ind
        (fun n0 : nat =>
           forall l0 : list A,
             List.nth_error l0 n0 = Some a ->
             exists l1 l2 : list A, l0 = (l1 ++ a :: l2)%list /\ length l1 = n0)
        (fun l0 : list A =>
           list_ind
             (fun l1 : list A =>
                List.nth_error l1 0 = Some a ->
                exists l2 l3 : list A, l1 = (l2 ++ a :: l3)%list /\ length l2 = 0)
             (fun H : List.nth_error nil 0 = Some a =>
                let H0 :
                      Some a = Some a ->
                      exists l1 l2 : list A, nil = (l1 ++ a :: l2)%list /\ length l1 = 0 :=
                    eq_ind (List.nth_error nil 0)
                           ...
                           (fun H0 : None = Some a =>
                              (fun H1 : None = Some a =>
                                 ...
                                 False_ind
                                   (exists l1 l2 : list A,
                                       nil = (l1 ++ a :: l2)%list /\ length l1 = 0) H2) H0)
                           (Some a) H in
                H0 eq_refl)
             (fun (x : A) (l1 : list A)
                  (_ : List.nth_error l1 0 = Some a ->
                       exists l2 l3 : list A,
                         l1 = (l2 ++ a :: l3)%list /\ length l2 = 0)
                  (H : List.nth_error (x :: l1) 0 = Some a) =>
                ex_intro
                  (fun l2 : list A =>
                     exists l3 : list A,
                       (x :: l1)%list = (l2 ++ a :: l3)%list /\ length l2 = 0) nil
                  (ex_intro
                     (fun l2 : list A =>
                        (x :: l1)%list = (nil ++ a :: l2)%list /\ length nil = 0) l1
                     (let H0 : x = a :=
                          f_equal
                            (fun e : option A =>
                      ...
                      (fun H1 : x = a =>
                         eq_ind_r
                           (fun x0 : A =>
                              (x0 :: l1)%list = (nil ++ a :: l1)%list /\ length nil = 0)
        ...
        (fun (n0 : nat)
           ...
           list_ind
             (fun l1 : list A =>
                ...
                exists l2 l3 : list A, l1 = (l2 ++ a :: l3)%list /\ length l2 = S n0)
             (fun H : List.nth_error nil (S n0) = Some a =>
                let H0 :
                      Some a = Some a ->
                      exists l1 l2 : list A, nil = (l1 ++ a :: l2)%list /\ length l1 = S n0 :=
                    eq_ind (List.nth_error nil (S n0))
                           (fun y : option A =>
                              y = Some a ->
                              exists l1 l2 : list A,
                                nil = (l1 ++ a :: l2)%list /\ length l1 = S n0)
                           (fun H0 : None = Some a =>
                              (fun H1 : None = Some a =>
                                 let H2 : False :=
                                     eq_ind None
                                 ...
                                 False_ind
                                   (exists l1 l2 : list A,
                                       nil = (l1 ++ a :: l2)%list /\ length l1 = S n0) H2) H0)
                           (Some a) H in
                H0 eq_refl)
             (fun (x : A) (l1 : list A)
                  (_ : List.nth_error l1 (S n0) = Some a ->
                       exists l2 l3 : list A,
                         l1 = (l2 ++ a :: l3)%list /\ length l2 = S n0)
                  (H : List.nth_error (x :: l1) (S n0) = Some a) =>
                let e :
                      exists l2 l3 : list A, l1 = (l2 ++ a :: l3)%list /\ length l2 = n0 :=
                    IH l1 H in
                ex_ind
                  (fun (l2 : list A)
                       (H0 : exists l3 : list A,
                           l1 = (l2 ++ a :: l3)%list /\ length l2 = n0) =>
                     ex_ind
                       (fun (l3 : list A)
                            (H1 : l1 = (l2 ++ a :: l3)%list /\ length l2 = n0) =>
                          and_ind
                            (fun (H2 : l1 = (l2 ++ a :: l3)%list) (H3 : length l2 = n0) =>
                               ex_intro
                                 (fun l4 : list A =>
                                    exists l5 : list A,
                                      (x :: l1)%list = (l4 ++ a :: l5)%list /\ length l4 = S n0)
                                 (x :: l2)%list
                                 (ex_intro
                                    (fun l4 : list A =>
                                       (x :: l1)%list = ((x :: l2) ++ a :: l4)%list /\
                                       length (x :: l2) = S n0) l3
                                    (conj
                                       (let H4 : l1 = (l2 ++ a :: l3)%list := H2 in
  ...
  Definition expected_nth_error_app1 : forall (A : Type) (l l' : list A) (n : nat),
  ...
  Definition expected_nth_error_app2 : forall (A : Type) (l l' : list A) (n : nat),
  ...
  Definition expected_remove : forall A : Type, (forall x y : A, {x = y} + {x <> y}) -> A -> list A -> list A :=
    fun (A : Type) (eq_dec : forall x y : A, {x = y} + {x <> y}) (x : A) (l : list A) =>
      list_rect (fun _ : list A => A -> list A) (fun _ : A => nil)
                (fun (r : A) (_ : list A) (remove : A -> list A) (x0 : A) =>
                   sumbool_rect (fun _ : {x0 = r} + {x0 <> r} => list A)
                                (fun _ : x0 = r => remove x0) (fun _ : x0 <> r => (r :: remove x0)%list)
                                (eq_dec x0 r)) l x.
  Lemma test_remove : actual_remove = expected_remove. Proof. reflexivity. Qed.

  Desugar last as actual_last.
  Definition expected_last : forall (A : Type) (l : list A), A -> A :=
    fun (A : Type) (l : list A) =>
  ...
  Definition expected_removelast : forall (A : Type) (l : list A), list A :=
    fun (A : Type) (l : list A) =>
      list_rect (fun _ : list A => list A) nil
                (fun (a : A) (l0 removelast : list A) =>
                   list_rect (fun _ : list A => list A) nil
                             (fun (_ : A) (_ _ : list A) => (a :: removelast)%list) l0) l.
  ...
  Definition expected_app_removelast_last : forall (A : Type) (l : list A) (d : A),
      l <> nil -> l = (List.removelast l ++ List.last l d :: nil)%list :=
    fun (A : Type) (l : list A) =>
      list_ind
        (fun l0 : list A =>
           forall d : A,
             l0 <> nil -> l0 = (List.removelast l0 ++ List.last l0 d :: nil)%list)
        (fun (d : A) (H : nil <> nil) =>
           let n : False := H eq_refl in
           False_ind (nil = (List.removelast nil ++ List.last nil d :: nil)%list) n)
        (fun (a : A) (l0 : list A)
             (IHl : forall d : A,
                 l0 <> nil ->
                 l0 = (List.removelast l0 ++ List.last l0 d :: nil)%list)
             (d : A) (_ : (a :: l0)%list <> nil) =>
           list_ind
             (fun l1 : list A =>
                (forall d0 : A,
                    l1 <> nil -> l1 = (List.removelast l1 ++ List.last l1 d0 :: nil)%list) ->
                (a :: l1)%list =
                (List.removelast (a :: l1) ++ List.last (a :: l1) d :: nil)%list)
             (fun
                 _ : forall d0 : A,
                   nil <> nil ->
                   nil = (List.removelast nil ++ List.last nil d0 :: nil)%list =>
                 eq_refl)
             (fun (a0 : A) (l1 : list A)
                  (_ : (forall d0 : A,
                           l1 <> nil ->
                           l1 = (List.removelast l1 ++ List.last l1 d0 :: nil)%list) ->
                       (a :: l1)%list =
                       (List.removelast (a :: l1) ++ List.last (a :: l1) d :: nil)%list)
                  (IHl0 : forall d0 : A,
                      (a0 :: l1)%list <> nil ->
                      (a0 :: l1)%list =
                      (List.removelast (a0 :: l1) ++ List.last (a0 :: l1) d0 :: nil)%list)
              =>
                eq_ind_r
                  (fun l2 : list A =>
                     (a :: l2)%list =
                     (List.removelast (a :: a0 :: l1) ++
                                      List.last (a :: a0 :: l1) d :: nil)%list) eq_refl
                  (IHl0 d
                        (fun H : (a0 :: l1)%list = nil =>
                           let H0 : False :=
                               eq_ind (a0 :: l1)%list
                                      (fun e : list A =>
                                         list_rect (fun _ : list A => Prop) False
  ...
  Definition expected_exists_last : forall (A : Type) (l : list A), l <> nil -> {l' : list A & {a : A | l = (l' ++ a :: nil)%list}} :=
    fun (A : Type) (l : list A) =>
      list_rect
        (fun l0 : list A =>
           l0 <> nil -> {l' : list A & {a : A | l0 = (l' ++ a :: nil)%list}})
        (fun H : nil <> nil =>
           let n : False := H eq_refl in
           False_rect {l' : list A & {a : A | nil = (l' ++ a :: nil)%list}} n)
        (fun (a : A) (l0 : list A)
             (IHl : l0 <> nil ->
                    {l' : list A & {a0 : A | l0 = (l' ++ a0 :: nil)%list}})
             (_ : (a :: l0)%list <> nil) =>
           list_rect
             (fun l1 : list A =>
                (l1 <> nil -> {l' : list A & {a0 : A | l1 = (l' ++ a0 :: nil)%list}}) ->
                {l' : list A & {a0 : A | (a :: l1)%list = (l' ++ a0 :: nil)%list}})
             (fun
                 _ : nil <> nil ->
                     {l' : list A & {a0 : A | nil = (l' ++ a0 :: nil)%list}} =>
                 existT
                   (fun l' : list A =>
                      {a0 : A | (a :: nil)%list = (l' ++ a0 :: nil)%list}) nil
                   (exist (fun a0 : A => (a :: nil)%list = (nil ++ a0 :: nil)%list) a
                          eq_refl))
             (fun (a0 : A) (l1 : list A)
                  (_ : (l1 <> nil ->
                        {l' : list A & {a1 : A | l1 = (l' ++ a1 :: nil)%list}}) ->
                       {l' : list A &
                             {a1 : A | (a :: l1)%list = (l' ++ a1 :: nil)%list}})
                  (IHl0 : (a0 :: l1)%list <> nil ->
                          {l' : list A &
                                {a1 : A | (a0 :: l1)%list = (l' ++ a1 :: nil)%list}}) =>
                let s :=
                    IHl0
                      (fun H : (a0 :: l1)%list = nil =>
                         let H0 : False :=
                ...
                sigT_rect
                  (fun
                      _ : {l' : list A &
                                {a1 : A | (a0 :: l1)%list = (l' ++ a1 :: nil)%list}} =>
                      {l' : list A &
                            {a1 : A | (a :: a0 :: l1)%list = (l' ++ a1 :: nil)%list}})
                  (fun (l' : list A)
                       (s0 : {a1 : A | (a0 :: l1)%list = (l' ++ a1 :: nil)%list}) =>
                     sig_rect
                       (fun _ : {a1 : A | (a0 :: l1)%list = (l' ++ a1 :: nil)%list} =>
                          {l'0 : list A &
                                 {a1 : A | (a :: a0 :: l1)%list = (l'0 ++ a1 :: nil)%list}})
                       (fun (a' : A) (H : (a0 :: l1)%list = (l' ++ a' :: nil)%list) =>
                          eq_rect_r
                            (fun l2 : list A =>
                               {l'0 : list A &
                                      {a1 : A | (a :: l2)%list = (l'0 ++ a1 :: nil)%list}})
                            (existT
                               (fun l'0 : list A =>
                                  {a1 : A |
                                   (a :: l' ++ a' :: nil)%list = (l'0 ++ a1 :: nil)%list})
                               (a :: l')%list
                               (exist
                                  (fun a1 : A =>
                                     (a :: l' ++ a' :: nil)%list =
                                     ((a :: l') ++ a1 :: nil)%list) a' eq_refl)) H) s0) s) l0
             IHl) l.
