(*
 * This is the same as Example.v, but using tactics.
 * We will slowly move more of this example to use tactics
 * as we implement more tactic support.
 *)
...
(* --- Lift, Unpack, and recover User-Friendly Types --- *)

Definition zipV {a} {b} {n} (v1 : vector a n) (v2 : vector b n) : vector (a * b) n.
Proof.
  algebraic_ornament list vector.
  - apply hs_to_coq.zip.
  - unpack zipV_p. (* TODO ... *)
Defined.
...
(*
 * TODO the rest
 * TODO update Nate issue when pushed, and explain
 * TODO add to tests
 * TODO run this example in test script, too
 *)
