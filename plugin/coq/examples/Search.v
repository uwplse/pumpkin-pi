...
fun (h : T) (n : nat) (p0 : VectorDef.t T n) (IHp : @eq (@sigT nat (fun H : nat => t T H)) (@existT nat (fun n0 : nat => t T n0) n p0)
  ...
  eq_ind
    (sigT (vector T)) 
    (existT _ n p0) 
    (fun (l3 : sigT (vector T)) => 
       existT _ (S n) (cons T h n p0) =
       existT _ (S (projT1 l3)) (cons T h (projT1 l3) (projT2 l3)))
    (eq_refl (existT _ (S n) (cons T h n p0))) 
    (existT _ 
      (Coq.Init.Specif.projT1 nat (λ (_ : nat) . (t (A [Rel 7]) (_ [Rel 1]))) (Search.ltv (A [Rel 6]) (Search.ltv_inv (A [Rel 6]) (existT nat (λ (_ : nat) . (t (A [Rel 7]) (_ [Rel 1]))) (n [Rel 3]) (t [Rel 2]))))) 
      (Search.ltv (A [Rel 6]) (Search.ltv_inv (A [Rel 6]) (existT nat (λ (_ : nat) . (t (A [Rel 7]) (_ [Rel 1]))) (n [Rel 3]) (t [Rel 2]))))) (_ [Rel 1]))))))
