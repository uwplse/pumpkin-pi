...
Module CaseStudy (Elem : Comparable).
  ...
  Module Ordered.
    ...
    Redirect "../out/search/baseEFF1000" Time Eval vm_compute in (search tree1000.2.2.2 Elem.x).
    Redirect "../out/search/baseEFF10000" Time Eval vm_compute in (search tree10000.2.2.2 Elem.x).
