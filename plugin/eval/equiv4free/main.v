...
Module CaseStudy (Elem : Comparable).
  ...
  Module Base.
    ...
    Redirect "../out/treeEFF1" Time Eval vm_compute in tree1.
    Redirect "../out/treeEFF10" Time Eval vm_compute in tree10.
    ...
    Definition preorder (t : tree) : list Elem.t :=
      tree_rect
        ...
        (fun x => [x])
        t.
    Redirect "../out/preorder/baseEFF1" Time Eval vm_compute in (preorder tree1).
    Redirect "../out/preorder/baseEFF10" Time Eval vm_compute in (preorder tree10).
    ...
    Definition inorder (t : tree) : list Elem.t :=
      tree_rect
        ...
        (fun x => [x])
        t.
    Redirect "../out/inorder/baseEFF1" Time Eval vm_compute in (inorder tree1).
    Redirect "../out/inorder/baseEFF10" Time Eval vm_compute in (inorder tree10).
    ...
    Definition postorder (t : tree) : list Elem.t :=
      tree_rect
        ...
        (fun x => [x])
        t.
    Redirect "../out/postorder/baseEFF1" Time Eval vm_compute in (postorder tree1).
    Redirect "../out/postorder/baseEFF10" Time Eval vm_compute in (postorder tree10).
  ...
  Module Sized.
    ...
    Redirect "../out/preorder/sizedEFF1" Time Eval vm_compute in (preorder' tree1).
    Redirect "../out/preorder/sizedEFF10" Time Eval vm_compute in (preorder' tree10).
    Redirect "../out/preorder/sizedEFF100" Time Eval vm_compute in (preorder' tree100).
    Redirect "../out/preorder/sizedEFF1000" Time Eval vm_compute in (preorder' tree1000).
    ...
    Redirect "../out/inorder/sizedEFF1" Time Eval vm_compute in (inorder' tree1).
    Redirect "../out/inorder/sizedEFF10" Time Eval vm_compute in (inorder' tree10).
    Redirect "../out/inorder/sizedEFF100" Time Eval vm_compute in (inorder' tree100).
    Redirect "../out/inorder/sizedEFF1000" Time Eval vm_compute in (inorder' tree1000).
    ...
    Redirect "../out/postorder/sizedEFF1" Time Eval vm_compute in (postorder' tree1).
    Redirect "../out/postorder/sizedEFF10" Time Eval vm_compute in (postorder' tree10).
    Redirect "../out/postorder/sizedEFF100" Time Eval vm_compute in (postorder' tree100).
    Redirect "../out/postorder/sizedEFF1000" Time Eval vm_compute in (postorder' tree1000).
  ...
  Module Ordered.
    ...
    Redirect "../out/search/baseEFF10" Time Eval vm_compute in (search tree10.2.2.2 Elem.x).
    ...
    Fail Redirect "../out/search/baseEFF1000" Time Eval vm_compute in (search tree1000.2.2.2 Elem.x).
    Fail Redirect "../out/search/baseEFF10000" Time Eval vm_compute in (search tree10000.2.2.2 Elem.x).
  ...
  Module Balanced.
    ...
    (* These time out on our architecture; remove the Fail if they don't on yours: *)
    Fail Redirect "../out/preorder/avlEFF1000" Time Eval vm_compute in (preorder' tree1000).
    ...
    (* These time out on our architecture; remove the Fail if they don't on yours: *)
    Fail Redirect "../out/inorder/avlEFF1000" Time Eval vm_compute in (inorder' tree1000).
    ...
    (* These time out on our architecture; remove the Fail if they don't on yours: *)
    Fail Redirect "../out/postorder/avlEFF1000" Time Eval vm_compute in (postorder' tree1000).
    ...
    (* These time out on our architecture; remove the Fail if they don't on yours: *)
    Fail Redirect "../out/search/avlEFF1000" Time Eval vm_compute in (search' tree1000 Elem.x).
    Fail Redirect "../out/search/avlEFF10000" Time Eval vm_compute in (search' tree10000 Elem.x).
