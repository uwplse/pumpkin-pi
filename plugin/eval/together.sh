...
for f in $(find out/normalized/*.out); do
  ...
  then 
     ...
     sed -i "s/(\* TIME-MEDIUM $name \*)/Redirect \"..\/out\/$dirname\/${suffix}200\" Time Eval vm_compute in ($defname _ _ _ _ tree200.2 Elem.x).\n\tRedirect \"..\/out\/$dirname\/${suffix}400\" Time Eval vm_compute in ($defname _ _ _ _ tree400 Elem.x).\n\tRedirect \"..\/out\/$dirname\/${suffix}600\" Time Eval vm_compute in ($defname _ _ _ _ tree600 Elem.x).\n\tRedirect \"..\/out\/$dirname\/${suffix}800\" Time Eval vm_compute in ($defname _ _ _ _ tree800 Elem.x).\n\tRedirect \"..\/out\/$dirname\/${suffix}1000\" Time Eval vm_compute in ($defname _ _ _ _ tree1000 Elem.x)./" equiv4free/main2.v
  else
     ...
     sed -i "s/(\* TIME-MEDIUM $name \*)/Redirect \"..\/out\/$dirname\/${suffix}200\" Time Eval vm_compute in ($defname _ _ _ _ tree200.2).\n\tRedirect \"..\/out\/$dirname\/${suffix}400\" Time Eval vm_compute in ($defname _ _ _ _ tree400.2).\n\tRedirect \"..\/out\/$dirname\/${suffix}600\" Time Eval vm_compute in ($defname _ _ _ _ tree600.2).\n\tRedirect \"..\/out\/$dirname\/${suffix}800\" Time Eval vm_compute in ($defname _ _ _ _ tree800.2).\n\tRedirect \"..\/out\/$dirname\/${suffix}1000\" Time Eval vm_compute in ($defname _ _ _ _ tree1000.2)./" equiv4free/main2.v
