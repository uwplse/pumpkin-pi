...
val pack : env -> evar_map -> int -> types -> evar_map * types
 ...
 *)
val pack_lift : env -> evar_map -> lifting -> types -> evar_map * types
 ...
 *)
val refold :
  lifting -> env -> evar_map -> types -> types -> types list -> evar_map * types
