...
(* Checks whether two terms are convertible *)
let convertible (env : env) (sigma : evar_map) (trm1 : types) (trm2 : types) : evar_map * bool =
  Reductionops.infer_conv
    env
    sigma
    (EConstr.of_constr trm1)
    (EConstr.of_constr trm2)
 ...
 * Return a new term
 *)
let rec map_term_env f d env sigma (a : 'a) (trm : types) : evar_map * types =
