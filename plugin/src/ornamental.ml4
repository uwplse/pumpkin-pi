...
| [ "Configure" "Lift" constr(d_orn) constr(d_orn_inv) "{" "constrs_a" "=" reference_list(constrs_a) ";" "constrs_b" "=" reference_list(constrs_b) ";" "elim_a" "=" reference(elim_a) ";" "elim_b" "=" reference(elim_b) ";" "id_eta_a" "=" reference(id_eta_a) ";" "id_eta_b" "=" reference(id_eta_b) ";" "iota_a" "=" reference_list(iota_a) ";" "iota_b" "=" reference_list(iota_b) "}" ] ->
  [ configure_lifting_manual d_orn d_orn_inv (constrs_a, constrs_b) (elim_a, elim_b) (id_eta_a, id_eta_b) (iota_a, iota_b) ]
END
