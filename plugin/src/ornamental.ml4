...
| [ "Configure" "Lift" constr(d_orn) constr(d_orn_inv) "{" "constrs_a" "=" reference_list(constrs_a) ";" "constrs_b" "=" reference_list(constrs_b) ";" "elim_a" "=" reference(elim_a) ";" "elim_b" "=" reference(elim_b) ";" "id_eta_a" "=" reference(id_eta_a) ";" "id_eta_b" "=" reference(id_eta_b) ";" "rew_eta_a" "=" reference_list(rew_eta_a) ";" "rew_eta_b" "=" reference_list(rew_eta_b) "}" ] ->
